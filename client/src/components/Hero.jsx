  ...
  return (
      ...
      <div className="flex flex-col justify-center w-full items-center lg:w-[1200px] lg:gap-10 md:gap-5 container md:px-8 px-4 py-8 lg:flex-row lg:py-16 mx-auto">
        <div className="flex flex-col  lg:w-1/3 ">
          ...
          <p
            className="flex flex-col  md:items-center lg:items-end 
             text-[hsla(36,4%,44%,1)] font-poppins font-medium 
             text-base leading-6 tracking-[0] text-right 
             w-full max-w-[347px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px]"
          >
